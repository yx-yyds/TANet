...
MODEL_NAME = "models.v2+nested-unet"
import importlib
...
from loss import cats_loss, rcf_loss, RWCE, rcf_mask3_loss
...
parser.add_argument('--tmp', help='tmp folder', default='./result-BSDS500/nested-unet')
# UAED_BSDS所在路径
parser.add_argument('--dataset', help='root folder of dataset', default=r'F:\experiments\dataset\BSDS-UAED')
